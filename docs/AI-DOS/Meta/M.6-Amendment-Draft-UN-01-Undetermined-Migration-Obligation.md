...
| Version | Proposed a change within M.6's own then-Draft `v1.1.0-draft`; this amendment document does not itself assign a new M.6 version. M.6 has since been canonically promoted as Version `1.1.0`, Status `Canonical`, effective upon merge of Promotion PR #372 at commit `7b5824e886661adf2c5027c08c59ccae137f0cdb`. |
| Status | **Draft.** Semantics reviewed and approved by Human Governance. Not independently canonical and never separately promoted; only its semantics were incorporated into M.6. Its incorporating candidate (`docs/AI-DOS/Meta/M.6-Versioning-Meta-Model.md`) was approved and canonically promoted as Version `1.1.0`, Status `Canonical`, effective upon merge of Promotion PR #372 at commit `7b5824e886661adf2c5027c08c59ccae137f0cdb`; see the `UN-01` Closure Record row below. |
| Canonical Status | Non-canonical. Its semantics are incorporated into the canonical `docs/AI-DOS/Meta/M.6-Versioning-Meta-Model.md`; this amendment document remains a non-canonical traceability record, not an independently canonical artifact. |
| `UN-01` Closure Record | **Closed.** The integrated M.6 candidate incorporating this amendment's approved semantics was canonically promoted when Promotion PR #372 merged into master at commit `7b5824e886661adf2c5027c08c59ccae137f0cdb`. `UN-01` closed as a direct consequence of that promotion becoming effective at the same merge. |
...
| Created | 2026-07-30 |
| Last Updated | 2026-07-31 (recorded Human Governance approval of these semantics and their incorporation into the integrated M.6 promotion candidate; same day, recorded that Human Governance has since approved that complete integrated candidate and authorized a Promotion PR proposing its canonical promotion, with `UN-01` closure proposed as a consequence effective only upon that Promotion PR's merge — see the `UN-01` Closure Record row above) |
| Post-Merge Effectiveness | Promotion PR #372 merged into master at commit `7b5824e886661adf2c5027c08c59ccae137f0cdb`; M.6 promotion and `UN-01` closure are effective. On 2026-08-01 Human Governance separately accepted the preserved M.6 Rule 8/Rule 8a policy, closing `SV-02`/`VS-Q2`/`NB-Q3`; see §8. |
...
| Incorporation Record | These approved semantics were incorporated into `docs/AI-DOS/Meta/M.6-Versioning-Meta-Model.md` §7.10, §8 (Rule 8a), §9, and §15 (VA-7, VA-8 revised; VA-25 added). Human Governance approved that integrated candidate as a complete artifact; canonical promotion (Version `1.1.0`, Status `Canonical`) became effective upon merge of Promotion PR #372 into master at commit `7b5824e886661adf2c5027c08c59ccae137f0cdb`. |
| Resolves | `UN-01` (Reconciliation Assessment: M.6's closed four-category Migration Obligation enumeration vs. the baseline's "insufficient information for a conclusion" requirement — Classification 6, definite semantic conflict) — **closed**, as recorded at the `UN-01` Closure Record row above. |
| Nature of this document | A drafted amendment whose semantics were reviewed and approved by Human Governance and incorporated into M.6. This document itself is not independently canonical. The integrated M.6 candidate was reviewed, approved, and canonically promoted upon merge of Promotion PR #372 at commit `7b5824e886661adf2c5027c08c59ccae137f0cdb`; `UN-01` closed as a consequence of that promotion and is now closed. |
| Supersedes | None |
| Superseded By | None |
...
## 5. Why `SV-02`, `VS-Q2`, and `NB-Q3` Remained Unresolved at Amendment Approval
...
Evidence that is inadequate or non-dispositive — absent, unavailable, thin, contested, contradictory, unresolved, or outside established evaluation scope — falls under Rule 8a and produces `Undetermined`; it is never part of the presumption-plus-rebuttal question described here. This amendment **only** prevents Rules 8, 9, and 10's existing mappings from manufacturing a substantive result where adequate evidence cannot establish one. At amendment approval, it took no position on the broader rebuttable-default acceptability question within Rule 8's evidence-adequate domain. Human Governance has since accepted that remaining M.6 policy and closed `SV-02`, `VS-Q2`, and `NB-Q3`; see §8. This subsequent decision changes no amendment semantic and no M.6 rule.

## 6. What This Amendment Does Not Do

- This amendment's semantics were reviewed and approved by Human Governance and incorporated into M.6. The integrated candidate was independently reviewed, approved, and canonically promoted when Promotion PR #372 merged at commit `7b5824e886661adf2c5027c08c59ccae137f0cdb`; `UN-01` is closed.
...
- Did not itself close `UN-01`; closure occurred as a consequence of M.6's canonical promotion at the Promotion PR #372 merge. Does not open or authorize Gate E or promote the Versioning Architecture draft. `SV-02`, `VS-Q2`, and `NB-Q3` are closed only by the subsequent Human Governance decision recorded at §8, not by this amendment.

## 7. Promotion Pathway

This amendment's semantics were routed through M.6's existing promotion authority: Framework Governance review, then Human Governance approval. Human Governance approved the integrated candidate and its canonical promotion became effective when Promotion PR #372 merged at commit `7b5824e886661adf2c5027c08c59ccae137f0cdb`.

The incorporation and effective promotion are recorded at M.6's own Document Metadata and §16. M.6 is now Version `1.1.0`, Status `Canonical`, effective from the Promotion PR #372 merge forward.

## 8. Subsequent Human Governance Policy Decision

Human Governance subsequently accepted the M.6 policy this amendment deliberately left open: Rule 8a has precedence whenever evidence is inadequate, contradictory, unresolved, outside evaluation scope, or otherwise non-dispositive, producing `Undetermined`; only within the adequate and dispositive evidence domain does Rule 8's MAJOR presumption continue, with `Migration-Needed` unless that adequate evidence establishes that no consumer action is required. On that basis, `SV-02`, `VS-Q2`, and `NB-Q3` are **closed**. This decision preserves M.6 unchanged and does not open, approve, or perform Gate E.
