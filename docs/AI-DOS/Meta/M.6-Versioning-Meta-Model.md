...
| Version | 1.1.0 (promoted designation per §7.5's Canonical Version Form rule; proposed by this Promotion PR — becomes M.6's effective version only upon merge into master; see §16) |
| Status | Canonical (proposed by this Promotion PR; **not yet effective** — becomes effective only upon merge into master; until merge, master's M.6 remains `1.1.0-draft`, Draft; see §16) |
...
| `UN-01` amendment integration | Integrated — the Human-Governance-approved M.6/UN-01 amendment (`docs/AI-DOS/Meta/M.6-Amendment-Draft-UN-01-Undetermined-Migration-Obligation.md`) is incorporated into this document as this integrated M.6 promotion candidate: `Undetermined` category (§7.10), Rule 8a (§8), first-class-state invariant (§9), and VA-7/VA-8 revisions plus VA-25 (§15). This integration did not itself constitute review, approval, or canonical promotion of the complete M.6 document. The independent complete-artifact review of this candidate has since been completed and ratified by Human Governance (see the Complete-Artifact Review row below); `UN-01` remains open until this integrated candidate is approved as a complete artifact and canonically promoted. |
...
| Canonical promotion | **Proposed** by this Promotion PR (Version `1.1.0`, Status `Canonical`, per §7.5's Canonical Version Form rule). **Not yet effective.** Effective only upon merge of this Promotion PR into master; merge, not commit, branch existence, or draft-PR creation, is the triggering event. See the decision record referenced above. |
| `UN-01` closure | **Proposed as a consequence of successful canonical promotion; not yet closed.** `UN-01` becomes closed only when this Promotion PR's canonical promotion becomes effective (i.e., upon merge into master), because `UN-01`'s approved amendment semantics are then incorporated into a canonical M.6 artifact. See `docs/AI-DOS/Meta/M.6-Amendment-Draft-UN-01-Undetermined-Migration-Obligation.md` and the decision record referenced above. |
| Governance | Review Authority step complete (row above); Human Governance approval of the complete artifact **granted** (row above); canonical promotion **proposed by this Promotion PR and effective only upon merge** into master (row above); until merge, master's M.6 remains `1.1.0-draft`, Draft, non-canonical, exactly as before this Promotion PR. |

M.6 does not alter project state, certify itself, implement tooling, or define operational procedures beyond what this authorized Promotion PR itself proposes. Incorporating the approved `UN-01` amendment above created the integrated M.6 promotion candidate; the independent complete-artifact review of that candidate was completed and ratified; Human Governance has now approved that candidate as a complete artifact and authorized its canonical promotion. This document's Version and Status fields and this section record that authorized promotion as **proposed** by this Promotion PR. Canonical promotion, and this document's own closure of `UN-01` as its consequence, become effective only when this Promotion PR is merged into master — this document does not itself close `UN-01` merely by stating this proposal, and no claim is made here that canonical promotion or `UN-01` closure has already taken effect while this Promotion PR remains unmerged.