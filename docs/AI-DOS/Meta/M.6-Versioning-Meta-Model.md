...
| Version | 1.1.0 (canonical designation per §7.5's Canonical Version Form rule; **effective**, upon merge of Promotion PR #372 into master at commit `7b5824e886661adf2c5027c08c59ccae137f0cdb`; see §16) |
| Status | Canonical (**effective**, upon merge of Promotion PR #372 into master at commit `7b5824e886661adf2c5027c08c59ccae137f0cdb`; see §16) |
...
| Created | 2026-07-14 |
| Last Updated | 2026-07-31 (incorporated the approved M.6/UN-01 amendment — `Undetermined` Migration Obligation category, Rule 8a, associated invariant, and VA-7/VA-8 revisions plus VA-25 — as this integrated promotion candidate, then corrected the §7.4 and §7.7 summary tables so neither bypasses Rule 8a's evidence-adequacy boundary; see §16. This corrects an internal-consistency defect within this candidate only — it does not itself constitute complete-artifact approval, canonical promotion, `UN-01` closure, or Gate E commencement. Same day: an independent complete-artifact technical review of this candidate was completed and ratified by Human Governance, for this candidate only, as discharging the Review Authority step — see §16 and `docs/AI-DOS/Architecture/Reports/AI-DOS-M.6-Integrated-Candidate-Complete-Artifact-Review-and-Human-Governance-Ratification.md`. This did not itself constitute complete-artifact approval, canonical promotion, `UN-01` closure, or Gate E commencement. Same day, in a separate, subsequent act: Human Governance approved this reviewed integrated candidate as a complete artifact and authorized preparation of the repository changes required for its canonical promotion; this document's Version and Status fields above, and §16 below, record that authorized promotion as proposed by this Promotion PR. Canonical promotion, and the consequent closure of `UN-01`, become effective only upon merge of this Promotion PR into master — not upon approval, not upon commit, and not upon the draft PR's mere existence. See `docs/AI-DOS/Architecture/Reports/AI-DOS-M.6-Human-Governance-Approval-Canonical-Promotion-and-UN-01-Closure-Decision-Record.md`.) |
| Post-Merge Effectiveness | Promotion PR #372 merged into master at commit `7b5824e886661adf2c5027c08c59ccae137f0cdb`; M.6 Version `1.1.0`, Status `Canonical`, and `UN-01` closure are effective from that merge forward. This lifecycle-normalization record changes no M.6 normative content. |
...
| `UN-01` amendment integration | Integrated — the Human-Governance-approved M.6/UN-01 amendment (`docs/AI-DOS/Meta/M.6-Amendment-Draft-UN-01-Undetermined-Migration-Obligation.md`) is incorporated into this document: `Undetermined` category (§7.10), Rule 8a (§8), first-class-state invariant (§9), and VA-7/VA-8 revisions plus VA-25 (§15). This integration did not itself constitute review, approval, or canonical promotion of the complete M.6 document; those steps followed separately (see the Complete-Artifact Review, Human Governance approval, and Canonical promotion rows below). `UN-01` is now closed, per the `UN-01` closure row below. |
| Complete-artifact review (Review Authority step) | **Completed and ratified**, 2026-07-31, by Human Governance, for this specific candidate only — see `docs/AI-DOS/Architecture/Reports/AI-DOS-M.6-Integrated-Candidate-Complete-Artifact-Review-and-Human-Governance-Ratification.md`. This ratification discharges the Review Authority requirement for this candidate; it is not a redefinition of the Enterprise Documentation Standards Board role and sets no repository-wide precedent. It does not itself constitute complete-artifact approval or canonical promotion. |
| Human Governance approval (complete artifact) | **Approved**, 2026-07-31, by Human Governance — approves the reviewed integrated M.6 candidate identified at the Complete-Artifact Review row above as a complete artifact, and authorizes preparation of the repository changes required for its canonical promotion. See `docs/AI-DOS/Architecture/Reports/AI-DOS-M.6-Human-Governance-Approval-Canonical-Promotion-and-UN-01-Closure-Decision-Record.md`. This approval is itself effective as a Human Governance decision; it authorizes, but by itself does not perform, canonical promotion. |
| Canonical promotion | **Effective.** Promotion PR #372 (Version `1.1.0`, Status `Canonical`, per §7.5's Canonical Version Form rule) merged into master at commit `7b5824e886661adf2c5027c08c59ccae137f0cdb`; that merge was the triggering event, per the decision record referenced above, and canonical promotion is effective from that commit forward. |
| `UN-01` closure | **Closed.** `UN-01` closed as the direct consequence of canonical promotion becoming effective at the merge of Promotion PR #372 into master (commit `7b5824e886661adf2c5027c08c59ccae137f0cdb`), because `UN-01`'s approved amendment semantics are now incorporated into this canonical M.6 artifact. See `docs/AI-DOS/Meta/M.6-Amendment-Draft-UN-01-Undetermined-Migration-Obligation.md` and the decision record referenced above. |
| Governance | Review Authority step complete (row above); Human Governance approval of the complete artifact **granted** (row above); canonical promotion **effective**, upon merge of Promotion PR #372 into master at commit `7b5824e886661adf2c5027c08c59ccae137f0cdb` (row above); master's M.6 is now `1.1.0`, Canonical. |

M.6 does not alter project state, certify itself, implement tooling, or define operational procedures beyond what the authorized Promotion PR proposed and its merge made effective. Incorporating the approved `UN-01` amendment above created the integrated M.6 promotion candidate; the independent complete-artifact review of that candidate was completed and ratified; Human Governance approved that candidate as a complete artifact and authorized its canonical promotion; Promotion PR #372 then merged into master at commit `7b5824e886661adf2c5027c08c59ccae137f0cdb`. This document's Version and Status fields and this section record that promotion as **effective** from that merge forward, and record `UN-01`'s consequent closure as **effective** from the same merge. Before that merge, this document and its promotion PR correctly described both as proposed and not yet effective; that historical distinction remains recorded at the Document Metadata `Last Updated` field above. This lifecycle-normalization pass changes no M.6 normative content (§§1–15 unchanged).
