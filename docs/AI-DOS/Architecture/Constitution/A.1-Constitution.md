...
`docs/AI-DOS/Architecture/Discovery/A.0-Framework-Audit.md` and related discovery artifacts may explain historical conditions, prior models, migration rationale, and architectural findings.
