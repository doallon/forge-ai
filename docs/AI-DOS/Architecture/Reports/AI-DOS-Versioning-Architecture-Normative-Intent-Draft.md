...
| Version | `1.0.0` (canonical designation per M.6 §7.5's Canonical Version Form rule; **proposed**, effective only upon merge of the corrected Promotion PR (PR #381) into `master`; not yet effective — see §13) |
| Status | **Draft. Normative Intent.** Approved by Human Governance, acting as a party distinct from this artifact's current Owner (`Framework Governance`), via a fresh canonical-promotion decision made after that ownership reassignment became repository-effective; Gate E is approved and closed for this candidate; canonical promotion is authorized but **proposed and not yet effective** — effective only upon merge of the corrected Promotion PR (PR #381) into `master`; see §13. |
| Canonical Status | Non-canonical until the corrected Promotion PR (PR #381) merges. Records the Human Governance Consolidated Versioning Architecture Closure selections as a normative-intent architecture artifact. Framework Governance's independent Gate E review (PR #380 head `02f7c5d346c989ad6edab512e6f5e89f88e4626e`) is complete and accepted. This artifact's Owner is `Framework Governance`, effective at PR #383 merge commit `9822bdd2fac376ac82ea7081ec15f487c308c6d0`; Human Governance, acting as a party distinct from that Owner, made a fresh canonical-promotion approval decision on 2026-08-03. Canonical promotion becomes effective only upon merge of the corrected Promotion PR (PR #381) — see §13. |
...
| Created | 2026-07-30 |
| Last Updated | 2026-08-03 (Gate E has been opened by a separate, explicit Human Governance decision, and this draft is now the identified Gate E review candidate — see `docs/AI-DOS/Architecture/Reports/AI-DOS-Versioning-Architecture-Gate-E-Opening-Decision-and-PR-B-Review-Candidate-Record.md`. This entry does not change this draft's substantive content, which remains exactly as recorded on 2026-08-01: M.6/M.7 promotion-effective dependency closure; Human Governance acceptance of the existing M.6 evidence-adequacy and MAJOR-presumption policy closing `SV-02`/`VS-Q2`/`NB-Q3`; and the `CP-01` dimension-scoped reconciliation rule. This draft remains Draft, non-canonical, not approved, and not promoted. Same day, in a further, separate, subsequent act: the independent Gate E review of this candidate (at PR #380 head `02f7c5d346c989ad6edab512e6f5e89f88e4626e`) was completed and accepted by Human Governance as the Framework Governance Gate E review result, and Human Governance approved this candidate and authorized canonical promotion — see `docs/AI-DOS/Architecture/Reports/AI-DOS-Versioning-Architecture-Gate-E-Approval-Canonical-Promotion-and-Program-Closure-Decision-Record.md`. An independent read-only re-review subsequently found that this approval's canonical-promotion component rested on an invalid authority basis, because this artifact's `Owner` and `Approval Authority` were both `Human Governance` at that time, contrary to M.4 §7.5's requirement that Canonical status be authorized by a party distinct from the entity Owner. That defect was not retroactively cured. Instead, Human Governance made a separate, deliberate decision reassigning this artifact's `Owner` to `Framework Governance` — see `docs/AI-DOS/Architecture/Reports/AI-DOS-Versioning-Architecture-Normative-Intent-Draft-Ownership-Alignment-Decision-Record.md` — effective at PR #383 merge commit `9822bdd2fac376ac82ea7081ec15f487c308c6d0`. After that reassignment became repository-effective, Human Governance, acting as a party distinct from this artifact's now-current Owner (`Framework Governance`) and considering the already-completed Framework Governance Gate E review, made a fresh canonical-promotion approval decision on 2026-08-03 — see §11 of the Gate-E-Approval-Canonical-Promotion-and-Program-Closure-Decision-Record.md (as corrected) for the complete, currently valid decision. This document's Version and Status fields above, and §13 below, record that fresh, valid promotion authorization as proposed by the corrected Promotion PR (PR #381). Canonical promotion becomes effective only upon merge of that corrected PR — not upon this approval, not upon commit, and not upon the draft PR's mere existence. This draft's substantive content (§§1–12) is unchanged by any of this.) |
...
**Gate E approval and merge-conditional canonical promotion (2026-08-03):** Human Governance has since made a further, separate, explicit decision accepting the completed independent Gate E review of this candidate (PR #380 head `02f7c5d346c989ad6edab512e6f5e89f88e4626e`) as the Framework Governance Gate E review result, approving this candidate as a complete artifact, recording Gate E as approved, satisfied, and closed, and authorizing canonical promotion — see `docs/AI-DOS/Architecture/Reports/AI-DOS-Versioning-Architecture-Gate-E-Approval-Canonical-Promotion-and-Program-Closure-Decision-Record.md`. This artifact's Document Metadata `Version` (`1.0.0`) and `Status`/`Canonical Status` fields above record that authorized promotion exactly as **proposed** by the Promotion PR. Canonical promotion, and the consequent closure of the bounded standalone Versioning Architecture Program, become effective only upon merge of that PR into `master` — not upon this approval, not upon commit, and not upon the Draft PR's mere existence. This artifact's substantive content (§§1–12) is unchanged by this update. Tooling, schema, CLI, automation, implementation, release, and Target integration remain separate, unauthorized future programs.

**Ownership-alignment prerequisite and fresh canonical-promotion decision (2026-08-03):** An independent read-only re-review of the Promotion PR found that the approval recorded immediately above rested on an invalid authority basis: this artifact's `Owner` and `Approval Authority` were both `Human Governance` at that time, which does not satisfy M.4 §7.5's requirement that Canonical status be authorized by a party distinct from the entity Owner. That defect was **not retroactively cured**. Instead, Human Governance made a separate, deliberate decision reassigning this artifact's `Owner` from `Human Governance` to `Framework Governance` — see `docs/AI-DOS/Architecture/Reports/AI-DOS-Versioning-Architecture-Normative-Intent-Draft-Ownership-Alignment-Decision-Record.md` — which became repository-effective at PR #383 merge commit `9822bdd2fac376ac82ea7081ec15f487c308c6d0` (this artifact's `Owner` field above now reads `Framework Governance` as a result). After that reassignment was repository-effective, Human Governance — acting as a party distinct from this artifact's now-current Owner and considering the already-completed Framework Governance Gate E review — made a **fresh** canonical-promotion approval decision, recorded at §11 of the Gate-E-Approval-Canonical-Promotion-and-Program-Closure-Decision-Record.md (as corrected). That fresh decision, not the earlier defective one, is the currently valid authority basis for this artifact's proposed `Version`/`Status`/`Canonical Status` above. This correction does not itself mutate the repository beyond this artifact's own metadata and the referenced decision record; does not make the corrected Promotion PR merge-ready without independent re-review against its exact new head; does not authorize that PR's merge; does not alter M.4, M.6, or M.7; does not reopen any completed Versioning Architecture decision; and does not authorize tooling, CLI, schema, conformance-engine, or other implementation work.
