...
|:---|:---|:---|
| A.1 | `docs/AI/Architecture/A.1-Constitution.md` | Normative authority for governance principles, planning, execution, review, certification, and lifecycle |
