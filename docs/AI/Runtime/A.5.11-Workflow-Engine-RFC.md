...
| Traceability ID | `FORGE-AI.V4.PHASE-2.ENGINE-11` |
| Scope | Architecture of the Workflow Engine — the Engine responsible for workflow definition management, workflow instance lifecycle, cross-engine step orchestration, workflow state tracking, governance-aware workflow authorization, and workflow artifact production within the Forge AI v4 Engine Platform. |
...
| Consumes | Document metadata rules; canonical terminology; framework and artifact meta-models; Runtime Architecture; Engine Platform architecture; Engine Kernel, Contract, Registry, Lifecycle, Communication, State, and Capability RFCs; A.5.0 Template section contract; A.5.1–A.5.9 upstream engine artifacts and operational capabilities (as orchestrated subjects); A.5.10 Governance Engine governance policies for workflow authorization and governance compliance |
| Produces | Workflow Engine architecture specification; workflow definition model; workflow instance lifecycle model; step orchestration model; workflow state machine; governance-aware workflow authorization model; workflow artifact model; workflow ownership definition |
| Related Specifications | A.5.1 — Context Engine RFC; A.5.2 — Knowledge Engine RFC; A.5.3 — Planning Engine RFC; A.5.4 — Decision Engine RFC; A.5.5 — Execution Engine RFC; A.5.6 — Validation Engine RFC; A.5.7 — Review Engine RFC; A.5.8 — Certification Engine RFC; A.5.9 — Memory Engine RFC; A.5.10 — Governance Engine RFC; A.5.12 — Registry Engine RFC (future) |
| Supersedes | None |
| Superseded By | None |
| Blocks | A.5.12 — Registry Engine RFC (Workflow Engine must be certified before Registry Engine enters review) |
| Blocked By | A.5.0 — Engine Specialization RFC Template (Template must be certified); A.5.1 — Context Engine RFC (Context Engine must be certified); A.5.2 — Knowledge Engine RFC (Knowledge Engine must be certified); A.5.3 — Planning Engine RFC (Planning Engine must be certified); A.5.4 — Decision Engine RFC (Decision Engine must be certified); A.5.5 — Execution Engine RFC (Execution Engine must be certified); A.5.6 — Validation Engine RFC (Validation Engine must be certified); A.5.7 — Review Engine RFC (Review Engine must be certified); A.5.8 — Certification Engine RFC (Certification Engine must be certified); A.5.9 — Memory Engine RFC (Memory Engine must be certified); A.5.10 — Governance Engine RFC (Governance Engine must be certified) |
...
10. STD-010 metadata compliance must be verified. All 25 mandatory fields and all conditionally mandatory fields must be present and correctly formatted.
