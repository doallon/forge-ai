...
| Field | Value |
|:---|:---|
| Identifier | `FORGE-TPL-PROJECT-GENERIC` |
...
| Traceability ID | `FORGE-AI.TEMPLATES.PROJECT.GENERIC` |
| Scope | Reusable output contract for generic project adoption documentation. |
...
| Produces | Generic Project document structure and placeholder manifest |
...
The Generic Project Template defines a framework-independent repository structure for projects adopting the AI Framework. Use this template when the technology stack is unknown, intentionally neutral, or not covered by a framework-specific template.
...
| `{{DOCUMENT_TITLE}}` | STRING | Title | Yes | Generic Project |
...
| `{{DOCUMENT_TYPE}}` | STRING | Document Type | Yes | Generic Project Specification |
...
| `{{PRODUCES}}` | LIST | Produces | Yes | Generic Project document structure and placeholder manifest |
...
| `{{PROJECT_TYPE}}` | STRING | Not applicable | Yes | Generic |
| `{{TARGET_PLATFORM}}` | STRING | Not applicable | Yes | Neutral / unspecified |
| `{{HOST_FRAMEWORK}}` | STRING | Not applicable | Yes | None / unspecified |
| `{{RUNTIME_CONTEXT}}` | STRING | Not applicable | Yes | Unspecified |
| `{{LANGUAGE_STACK}}` | STRING | Not applicable | Yes | Unspecified |
...
| Target Platform | Neutral / unspecified |
| Host Framework | None / unspecified |
| Runtime Context | Unspecified |
| Language Stack | Unspecified |
...
## 13. Generic Source Layout

The Generic template documents a neutral source layout without prescribing language, framework, runtime, package manager, deployment model, or implementation behavior.
