...
| Normative References | `docs/AI/GOVERNANCE.md`; `docs/AI/Architecture/A.1-Constitution.md`; `docs/AI/Architecture/Standards/STD-000-Framework-Standards.md`; `docs/AI/Architecture/Standards/STD-003-Terminology-Standard.md`; `docs/AI/Architecture/Standards/STD-010-Document-Metadata-Standard.md`; Invocation Context and Resolved Target Context. |
