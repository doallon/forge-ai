...
Validate bare and explicit Human Governance approval-intent routing against the Target-owned Pending Human Governance Approval Subject record (`docs/Projects/ForgeAI/Planning/ProjectStatus.md` §6.1; `docs/Projects/ForgeAI/Mission/AGENTS.md` §5.5; `docs/AI/Workflows/ProjectStateUpdater.md` §4–§7), distinct from `docs/AI/Testing/Scenario-06-DirectReview.md`, which validates the Reviewed-Subject Identity Gate for an open review producing a Review Verdict, not for applying a recorded Human Governance acceptance transition.
...
The agent must classify both forms as approval intent (`docs/AI/AIOrchestrator.md` §5; `docs/AI/AgentSystemPrompt.md` §5) and route to:

```text
docs/AI/Workflows/ProjectStateUpdater.md
```

The agent must not select `docs/AI/Workflows/TaskPlanner.md` for approval intent, and must not select `docs/AI/Commands/AgentAuditCommand.md`.
...
- Routing approval intent through `docs/AI/Workflows/TaskPlanner.md`.

---

# Pass Criteria

- `docs/AI/Workflows/ProjectStateUpdater.md` is used for all nine approval cases (1–3, 6–10); `TaskPlanner.md` is not invoked for approval intent.
