...
| Canonical Path | `docs/AI/Architecture/Blueprint/AI-DOS-Blueprint-v1.0-RFC.md` |
...
| :--- | :--- | :--- |
| Meta Core | `docs/AI/Meta/README.md`, `M.0`, `M.1`, `M.2`, `M.3` | Foundation for framework ownership, artifacts, identity, and relationships. |
...
| :------ | :-------------- | :------------- |
| Governance authority | Human Governance, `docs/AI/FrameworkGovernance.md`, `docs/AI/GOVERNANCE.md`, Constitution | Describes topology only. |
| Framework semantic meaning | `docs/AI/Meta/M.0-Framework-Meta-Model.md` | Places Meta foundation. |
| Artifact meaning | `docs/AI/Meta/M.1-Artifact-Meta-Model.md` | References owner. |
| Identity | `docs/AI/Meta/M.2-Identity-Meta-Model.md` | References owner. |
| Relationships | `docs/AI/Meta/M.3-Relationships-Meta-Model.md` | References owner. |
| Lifecycle/status | `docs/AI/Meta/M.4-Lifecycle-Meta-Model.md` | References owner. |
| Evidence | `docs/AI/Meta/M.5-Evidence-Meta-Model.md` | References owner. |
| Versioning | `docs/AI/Meta/M.6-Versioning-Meta-Model.md` | References owner. |
| Compatibility | `docs/AI/Meta/M.7-Compatibility-Meta-Model.md` | References owner. |
| Extension | `docs/AI/Meta/M.8-Extension-Meta-Model.md` | References owner. |
| Schema/validation meaning | `docs/AI/Meta/M.9-Schema-Validation-Meta-Model.md` | References owner. |
| Standards requirements | `docs/AI/Architecture/Standards/STD-000-Framework-Standards.md` and dependent Standards | Shows standards position. |
| System invocation flow | `docs/AI/System/README.md` and active System documents | Summarizes canonical flow. |
| Runtime behavior | `docs/AI/Runtime/A.3-Runtime-Architecture-RFC.md` | Positions Runtime. |
| Engine behavior | `docs/AI/Runtime/A.4-Engine-Architecture-RFC.md`, A.4.1–A.4.7, A.5.1–A.5.12 | Lists inventory. |
| Agent architecture | AGENTS v2 family under `docs/AI/Architecture/Agents/` | Positions Agents as consumers. |
| Command contracts | `docs/AI/Commands/` | Positions command family. |
| Workflow contracts | `docs/AI/Workflows/` and workflow templates | Positions workflow family. |
| Template contracts | `docs/AI/Templates/` | Positions template family. |
| Knowledge | `docs/AI/Templates/Knowledge/`, `STD-001`, Knowledge Engine | Positions consumption boundary. |
| Memory | `docs/AI/Templates/Memory/`, Memory Engine | Positions consumption boundary. |
| Validation procedure | `docs/AI/Validation/` and Validation Engine | Separates Validation. |
| Review procedure | Review templates, Agent review model, Review Engine | Separates Review. |
| Certification procedure | `docs/AI/Certification/`, `docs/AI/Validation/ValidationCertification.md`, Certification Engine | Separates Certification. |
...
- Product and governance: `docs/AI/README.md`, `docs/AI/GOVERNANCE.md`, `docs/AI/FrameworkGovernance.md`, `docs/AI/AIFramework.md`, `docs/AI/AIOrchestrator.md`, `docs/AI/AgentSystemPrompt.md`, `docs/AI/Architecture/A.1-Constitution.md`.
- Meta: `docs/AI/Meta/README.md`, `docs/AI/Meta/M.0-Framework-Meta-Model.md`, `docs/AI/Meta/M.1-Artifact-Meta-Model.md`, `docs/AI/Meta/M.2-Identity-Meta-Model.md`, `docs/AI/Meta/M.3-Relationships-Meta-Model.md`, `docs/AI/Meta/M.4-Lifecycle-Meta-Model.md`, `docs/AI/Meta/M.5-Evidence-Meta-Model.md`, `docs/AI/Meta/M.6-Versioning-Meta-Model.md`, `docs/AI/Meta/M.7-Compatibility-Meta-Model.md`, `docs/AI/Meta/M.8-Extension-Meta-Model.md`, `docs/AI/Meta/M.9-Schema-Validation-Meta-Model.md`.
- Standards: `docs/AI/Architecture/Standards/STD-000-Framework-Standards.md`, `docs/AI/Architecture/Standards/STD-010-Document-Metadata-Standard.md`, `docs/AI/Architecture/Standards/STD-001-Knowledge-Graph-Standard.md`, `docs/AI/Architecture/Standards/STD-002-Discovery-Standard.md`, `docs/AI/Architecture/Standards/STD-003-Terminology-Standard.md`.
- System: `docs/AI/System/README.md`, `docs/AI/System/BootSequence.md`, `docs/AI/System/TargetRepositoryResolution.md`, `docs/AI/System/ContextAssembly.md`, `docs/AI/System/SourceOfTruth.md`, `docs/AI/System/AuthorityModel.md`, `docs/AI/System/DecisionModel.md`, `docs/AI/System/ExecutionSequence.md`, `docs/AI/System/SystemLayerFreeze.md`.
- Runtime and Engines: `docs/AI/Runtime/README.md`, `docs/AI/Runtime/A.3-Runtime-Architecture-RFC.md`, `docs/AI/Runtime/A.4-Engine-Architecture-RFC.md`, `docs/AI/Runtime/A.4.1-Engine-Kernel-RFC.md`, `docs/AI/Runtime/A.4.2-Engine-Contract-RFC.md`, `docs/AI/Runtime/A.4.3-Engine-Registry-RFC.md`, `docs/AI/Runtime/A.4.4-Engine-Lifecycle-RFC.md`, `docs/AI/Runtime/A.4.5-Engine-Communication-RFC.md`, `docs/AI/Runtime/A.4.6-Engine-State-RFC.md`, `docs/AI/Runtime/A.4.7-Engine-Capability-RFC.md`, `docs/AI/Runtime/A.5.0-Engine-Specialization-RFC-Template.md`, `docs/AI/Runtime/A.5.1-Context-Engine-RFC.md`, `docs/AI/Runtime/A.5.2-Knowledge-Engine-RFC.md`, `docs/AI/Runtime/A.5.3-Planning-Engine-RFC.md`, `docs/AI/Runtime/A.5.4-Decision-Engine-RFC.md`, `docs/AI/Runtime/A.5.5-Execution-Engine-RFC.md`, `docs/AI/Runtime/A.5.6-Validation-Engine-RFC.md`, `docs/AI/Runtime/A.5.7-Review-Engine-RFC.md`, `docs/AI/Runtime/A.5.8-Certification-Engine-RFC.md`, `docs/AI/Runtime/A.5.9-Memory-Engine-RFC.md`, `docs/AI/Runtime/A.5.10-Governance-Engine-RFC.md`, `docs/AI/Runtime/A.5.11-Workflow-Engine-RFC.md`, `docs/AI/Runtime/A.5.12-Registry-Engine-RFC.md`.
- Agents: AGENTS v2 family under `docs/AI/Architecture/Agents/`, especially `AGENTS-v2.md` and `AGENTS-v2-Architecture.md`.
- Operational families: `docs/AI/Commands/`, `docs/AI/Workflows/`, `docs/AI/Templates/`, `docs/AI/Validation/`, `docs/AI/Certification/`, `docs/AI/Testing/`, `docs/AI/Operational/Operational-Core-Replacement-Matrix.md`.
...
- Active Blueprint resolved to `docs/AI/Architecture/Blueprint/AI-DOS-Blueprint-v1.0-RFC.md`.
