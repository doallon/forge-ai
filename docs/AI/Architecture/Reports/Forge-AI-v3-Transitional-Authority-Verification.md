...
- `docs/AI/FrameworkGovernance.md` states that the Blueprint RFC remains non-canonical planning input until ratified through Framework Governance.
...
- `docs/AI/FrameworkGovernance.md` states that `ProjectStatus` records live operational state only and cannot promote architecture, ratify RFCs, or supersede authority documents.
...
No corrective implementation is required for transitional authority alignment. If desired, create a follow-up documentation-only task to normalize authority-chain wording across `docs/AI/AgentSystemPrompt.md`, `docs/AI/FrameworkGovernance.md`, and `docs/AI/README.md`.
