...
| Field | Value |
|:---|:---|
| Identifier | `FORGE-AI.V2.REPOSITORY-AUDIT-002` |
...
| Traceability ID | `FORGE-AI.V2.REPOSITORY-AUDIT-002` |
...
| Normative References | `docs/AI/System/TargetRepositoryResolution.md`; `docs/AI/System/SystemLayerFreeze.md`; `docs/AI/Architecture/Reports/Target-Project-Path-Resolution.md`; `docs/AI/Architecture/Reports/Forge-AI-Repository-Rationalization-Audit.md`; `docs/AI/Architecture/Reports/Forge-AI-Repository-Classification-Audit-v1.0.md`; `docs/DevelopmentPhases/ProjectStatus.md`; `docs/DevelopmentPhases/ForgeAI-DevelopmentPhases.md`; `docs/Roadmap/Forge-AI-Program-Architecture-Master-Roadmap-v4.md`; `docs/AI/Architecture/Standards/STD-003-Terminology-Standard.md`; `docs/AI/Architecture/Standards/STD-010-Document-Metadata-Standard.md` |
...
This audit is the definitive repository architecture reclassification for the Forge AI repository after the AI-DOS architectural evolution. It supersedes the previous Repository Rationalization Audit as the active cleanup reference while preserving that previous audit as historical evidence.
...
2. **Forge AI Target Project** owns Forge AI self-hosting project truth: root `AGENTS.md`, Forge AI ProjectStatus, DevelopmentPhases, Roadmap, repository state, cleanup queue, frozen areas, and self-hosting operational decisions.
3. **Forge Agent** consumes both and produces task-scoped execution evidence only.
...
| Framework / Target Project separation | Separation is documented, but older repository locations still blur Framework assets and Forge AI project-governance assets. | PASS WITH STRUCTURAL FINDINGS |
...
| Self-hosting consistency | Self-hosting mapping is documented; cleanup must preserve Forge AI-specific status and roadmap paths. | PASS |
...
|:---|:---|:---|:---|:---|:---|:---|:---|:---|
| AI root | `docs/AI/*.md` | Mixed: Framework Governance / Operational maintainers | Framework entry, operational compatibility, governance atlas. | Mixed Framework authority and frozen operational compatibility. | Active / frozen compatibility. | Consumed by Forge AI self-hosting and external Target Repositories. | Core AI-DOS provider content. | KEEP / KEEP_FROZEN |
...
| Reports | `docs/AI/Architecture/Reports/`, `*/Reports/` | Report-specific owners | Audit, review, freeze, normalization, migration evidence. | Evidence only unless explicitly accepted as active cleanup reference. | Historical / reference / active audit. | Supports Forge AI self-hosting decisions. | Evidence asset. | REFERENCE_ONLY / ARCHIVE |
| Roadmap | `docs/Roadmap/` | Forge AI Target Project Governance | Forge AI project roadmap. | Forge AI Target Project roadmap. | Active Target Project planning. | Forge AI self-hosting project truth. | Not universal AI-DOS path. | KEEP_SELF_HOSTING |
| DevelopmentPhases | `docs/DevelopmentPhases/` | Forge AI Target Project Governance | Forge AI phase sequence and historical development evidence. | Forge AI Target Project planning / state support. | Active plus historical. | Forge AI self-hosting project truth. | Not universal external Target Repository authority. | KEEP_SELF_HOSTING / ARCHIVE |
| ProjectStatus | `docs/DevelopmentPhases/ProjectStatus.md` | Forge AI Target Project Governance | Live Forge AI operational state. | Live project state, not architecture. | Live operational state. | Forge AI self-hosting project truth. | Consumed by AI-DOS while self-hosting. | KEEP_SELF_HOSTING |
...
| Planning | `docs/AI/Templates/Planning/`, `docs/DevelopmentPhases/`, reports | Mixed | Planning templates and Forge AI plans. | Template authority or project planning. | Mixed active / historical. | Project-specific plans belong to Target Project. | Templates are AI-DOS assets. | KEEP_SELF_HOSTING / ARCHIVE |
...
| Project | `docs/AI/Templates/Project/`, `docs/DevelopmentPhases/`, `docs/Roadmap/` | Mixed Framework / Forge AI Target Project Governance | Project templates and Forge AI project truth. | Templates plus target project state. | Mixed frozen / active self-hosting. | Project truth belongs to active Target Repository. | AI-DOS provides templates only. | KEEP_SELF_HOSTING / KEEP_FROZEN |
...
| DevelopmentPhases active files | Forge AI Target Project Governance | Forge AI Target Project / Active Architecture planning | KEEP_SELF_HOSTING | `docs/DevelopmentPhases/` |
| DevelopmentPhases historical files | Forge AI Target Project Governance | Historical Evidence | ARCHIVE | Future `docs/Archive/DevelopmentPhases/` after authorization |
| ProjectStatus | Forge AI Target Project Governance | Forge AI Target Project / Active operational state | KEEP_SELF_HOSTING | `docs/DevelopmentPhases/ProjectStatus.md` |
| Roadmap | Forge AI Target Project Governance | Forge AI Target Project / Active planning | KEEP_SELF_HOSTING | `docs/Roadmap/` |
...
| DevelopmentPhases | KEEP_SELF_HOSTING | Forge AI Target Project planning truth. |
| ProjectStatus | KEEP_SELF_HOSTING | Forge AI Target Project live operational state. |
| Roadmap | KEEP_SELF_HOSTING | Forge AI Target Project roadmap truth. |
...
| Project templates | KEEP_FROZEN | Reusable AI-DOS templates distinct from Forge AI project truth. |
...
docs/
  ...
  DevelopmentPhases/                     # Forge AI self-hosting project truth
    ProjectStatus.md
    ForgeAI-DevelopmentPhases.md
    historical/                          # optional future archive subdivision
  Roadmap/                               # Forge AI self-hosting roadmap truth
...
| DevelopmentPhases | Forge AI Target Project phase sequence, not universal external Target Repository phase authority. | `docs/DevelopmentPhases/ForgeAI-DevelopmentPhases.md` |
| Roadmap | Forge AI Target Project roadmap, not AI-DOS Framework architecture. | `docs/Roadmap/` |
| Historical DevelopmentPhases evidence | Forge AI project history, not active Framework architecture. | `docs/DevelopmentPhases/` or future `docs/Archive/DevelopmentPhases/` |
...
| Obsolete path assumptions | Older docs assume Forge AI paths as universal. | Conflicts with Target Repository path model. | Archive or annotate during cleanup; do not rewrite in this audit. |
...
| Expected Repository State | Forge AI self-hosting project truth is clearly separated from historical project planning. |
...
6. Repository layout still allows confusion between AI-DOS Framework assets and Forge AI Target Project truth.
...
1. Execute final repository cleanup under `FORGE-AI.V2.REPOSITORY-CLEANUP-001`.
...
4. Validate external Target Repository boot with no Forge AI self-hosting path fallback assumptions.
5. Validate TargetRepositoryResolution against an external Target Repository declaration.
6. Confirm Axis Suite-specific ProjectStatus, DevelopmentPhases, Roadmap, protected areas, and validation commands are owned by Axis Suite, not by Forge AI.
...
| Self-hosting consistency | PASS | Forge AI self-hosting paths are documented as local mappings only. |
...
6. Axis Suite-specific project truth is not yet present in this repository and must not be invented by Forge AI.
...
1. Execute only the next authorized task: `FORGE-AI.V2.REPOSITORY-CLEANUP-001 — EXECUTE FINAL REPOSITORY CLEANUP`.
