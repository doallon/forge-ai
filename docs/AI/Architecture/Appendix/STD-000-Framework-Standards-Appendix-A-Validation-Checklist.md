...
| Check ID | Requirement | Constitutional Reference | Severity | Evidence Expected |
|:---|:---|:---|:---|:---|
| VC-CON-001 | The standard does not redefine constitutional authority. | [A.1 §5](../A.1-Constitution.md#5-constitutional-scope); STD-000 §5 | Blocking | Authority analysis against Constitution. |
...
| Check ID | Requirement | Constitutional Reference | Severity | Evidence Expected |
|:---|:---|:---|:---|:---|
| VC-TERM-001 | Terms are used consistently throughout the standard. | [§19 Glossary](./STD-000-Framework-Standards.md#19-glossary); §19 Terminology Rules | Blocking | Terminology usage audit. |
